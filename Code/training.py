...
from transformers import XLMRobertaForQuestionAnswering, Trainer, TrainingArguments
...
model.save_pretrained("output/fine_tuned_xlm_roberta_qa_large_20")
tokenizer.save_pretrained("output/fine_tuned_xlm_roberta_qa_large_20")
