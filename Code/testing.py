...
tokenizer = XLMRobertaTokenizerFast.from_pretrained("output/fine_tuned_xlm_roberta_qa_large_20")
model = XLMRobertaForQuestionAnswering.from_pretrained("output/fine_tuned_xlm_roberta_qa_large_20")

# Load the CSV file
input_df = pd.read_csv("input_data_evaluation_es.csv", sep=";")
...
input_df.to_csv("results/results_es_xlmr_large.csv", sep=";", index=False)
